...
<div class="sign-up-l fr">
                <form method="post">
                    <p class="inpt">
<input type="text" name="fname" placeholder="username" required><i class="fa fa-user fas"></i></p>
<p class="inpt">
<input type="email" name="uid" placeholder="email" required><i class="fa fa-envelope fas"></i></p>
<p class="inpt">
<input type="password" name="pass" placeholder="password"><i class="fa fa-lock fas"></i></p>
<p>
<input type="submit"  name="sub" value="Sign up" class="sub"></p>
</form>
</div>
</div>
</div>
